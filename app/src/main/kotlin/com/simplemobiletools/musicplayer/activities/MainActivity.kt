...
class MainActivity : SimpleActivity(), SeekBar.OnSeekBarChangeListener {
    ...
    fun songDownloadedEvent(event: Events.SongDownloaded) {
        ...
        // log it for now; TODO: add playlist, then add Song object to the playlist
        Log.e("HELLO THERE", "filename is ${event.path.absolutePath} and playlist is ${event.playlistName}")
        ...
        Log.e("songDownloadedEvent", "Am I the main thread? ${am_i}")
